"""
Base Django settings for censeo project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-0mkfd#1@--vb!m5zc^6j7at!cjzi5sjra%ghekw%z7)3_829dz')
...
LOCAL_APPS = [
    'core',  # Main app for models and business logic
]
